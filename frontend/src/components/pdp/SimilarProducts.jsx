...
export default function SimilarProducts() {
  const products = [
    { brand: 'Imsa Moda', desc: 'Men Henley Neck T-shirt', current: 441, original: 1999, discount: '78% OFF', rating: '4.2', ad: true, image: simImg1 },
    { brand: 'Black Pigeon', desc: 'Men Printed T-shirt', current: 304, original: 699, discount: '57% OFF', image: simImg2 },
    { brand: 'Black Pigeon', desc: 'Men Printed T-shirt', current: 304, original: 699, discount: '57% OFF', image: simImg3 },
  ];
